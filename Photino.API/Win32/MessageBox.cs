...
namespace PhotinoAPI.Win32
{
    public static class MessageBox
    {
        ...
        public static MessageBoxResult Show(IntPtr owner, string text, string caption)
        {
            return (MessageBoxResult)MessageBoxA(owner, text, caption, (uint)MessageBoxButtons.Ok);
        }

        // ReSharper disable once MethodOverloadWithOptionalParameter
        public static MessageBoxResult Show(IntPtr owner, string text, string caption, MessageBoxButtons buttons = MessageBoxButtons.Ok)
        {
            return (MessageBoxResult)MessageBoxA(owner, text, caption, (uint)buttons);
        }

        public static MessageBoxResult Show(IntPtr owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon)
        {
            return (MessageBoxResult)MessageBoxA(owner, text, caption, ((uint)buttons) | ((uint)icon));
        }

        public static MessageBoxResult Show(IntPtr owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton button)
        {
            return (MessageBoxResult)MessageBoxA(owner, text, caption, ((uint)buttons) | ((uint)icon) | ((uint)button));
        }

        public static MessageBoxResult Show(IntPtr owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton button, MessageBoxModal modal)
        {
            return (MessageBoxResult)MessageBoxA(owner, text, caption, ((uint)buttons) | ((uint)icon) | ((uint)button) | ((uint)modal));
        }
    }
